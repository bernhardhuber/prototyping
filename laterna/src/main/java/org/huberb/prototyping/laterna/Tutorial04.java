package org.huberb.prototyping.laterna;
 ...
 * @author Martin
 * @see
 * <a href="https://github.com/mabe02/lanterna/blob/master/src/test/java/com/googlecode/lanterna/tutorial/Tutorial04.java">Tutorial04</a>
 */
    ...
    public static void main(String[] args) {
        ...
        try (final Screen screen = terminalFactory.createScreen()) {
            ...
            contentPanel.addComponent(new Button("Close",
                    window::close).setLayoutData(GridLayout.createHorizontallyEndAlignedLayoutData(2))
            );
            ...
            Logger.getLogger(Tutorial04.class.getName()).log(Level.SEVERE, "createScreen", ex);
        }
    }
}
