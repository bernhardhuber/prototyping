...
public class RadioListDialogBuilder<T> extends AbstractDialogBuilder<RadioListDialogBuilder<T>, RadioListDialog<T>> {
    ...
    public RadioListDialogBuilder() {
        super("RadioListDialog");
    ...
    @Override
    protected RadioListDialogBuilder<T> self() {
        return this;
    }

    @Override
    protected RadioListDialog<T> buildDialog() {
        return new RadioListDialog<>(
                title,
                description,
                this.listBoxSize,
                this.content);
     ...
     * @return Itself
     */
    public RadioListDialogBuilder<T> setListBoxSize(TerminalSize listBoxSize) {
     ...
     * @return Itself
     */
    public RadioListDialogBuilder<T> addListItem(T item) {
     ...
     */
    @SafeVarargs
    public final RadioListDialogBuilder<T> addListItems(T... items) {
