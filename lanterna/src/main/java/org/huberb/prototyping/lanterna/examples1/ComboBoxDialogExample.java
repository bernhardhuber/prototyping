...
import org.huberb.prototyping.lanterna.examples.dialogs.ComboBoxDialog;
 ...
 * @author berni3
 */
public class ComboBoxDialogExample extends AbstractLanternaApplicationTemplate {

    public static void main(String[] args) throws Exception {
        LanternaLauncher.launchWithClass(ComboBoxDialogExample.class, args);
    }

    public ComboBoxDialogExample() {
        super(ComboBoxDialogExample.class.getName());
    }
    ...
    void showDialog(MultiWindowTextGUI textGUI) {
        ...
        final List<ItemLabel> result = ComboBoxDialog.showDialog(
                textGUI,
                this.getClass().getName(),
                "description",
                items
        );
        System.out.printf("%s result %s%n", ComboBoxDialogExample.class.getName(),
                result.stream()
                        .map((il) -> il.getItem())
